            ...
            <div class="container-fluid px-4 my-3 mx-3">
                <div class="myTable">
                    <table id="mytable">
                        ...
                        <tbody>
                            <?php
                            $cno = $_GET['customer_no'];
                            $sql1="SELECT * FROM customers WHERE cno='$cno'";
                            $result1=mysqli_query($con, $sql1);
                            $row1= mysqli_fetch_assoc($result1);
                        echo'<h4 id="edit_appoinments">History of '.$row1['cname'].' </h4>
                        <p><label for="">Customer Name:</label> <span><strong>'.$row1['cmail'].'</strong></span></p>
                        ...
                        <p><label for="">Phone Number:</label> <span><strong>'.$row1['TimeStmp'].'</strong></span></p>
                        ';
